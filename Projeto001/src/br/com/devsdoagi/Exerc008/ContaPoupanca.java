...
public class ContaPoupanca extends Conta {
    ...
    public ContaPoupanca(String numeroConta, double saldo, Cliente cliente, String titular) {
    ...
    public void aplicarJuros(){
        ...
        System.out.printf("Segue o saldo conforme a aplicação do juros: %.2f", total);
    }
}
